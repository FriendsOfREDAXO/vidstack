import { Host, effect, computed, setAttribute } from './vidstack-CRlI3Mh7.js';
import { MediaProvider, MediaPlayer } from './vidstack-Dvnit1xI.js';
...
class MediaProviderElement extends Host(HTMLElement, MediaProvider) {
  ...
  #createGoogleCastContainer() {
    ...
    import('./vidstack-DJTshtlu.js').then(({ insertContent }) => {
