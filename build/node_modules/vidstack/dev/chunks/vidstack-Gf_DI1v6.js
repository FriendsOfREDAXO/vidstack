...
import { canOrientScreen, IS_IPHONE, isAudioSrc, canPlayAudioType, isVideoSrc, canPlayVideoType, isHLSSupported, isHLSSrc, isDASHSupported, isDASHSrc, IS_CHROME, IS_IOS, canGoogleCastSrc, canChangeVolume } from './vidstack-uKxEd7nI.js';
import { TimeRange, getTimeRangesStart, getTimeRangesEnd, updateTimeIntervals } from './vidstack-B5ElR9su.js';
import { isTrackCaptionKind, TextTrackSymbol, TextTrack } from './vidstack-Dn8_b_Q6.js';
...
import { preconnect, getRequestCredentials } from './vidstack-DCY5OwWc.js';
  ...
  async requestGoogleCast(trigger) {
    try {
      ...
      if (!this.#googleCastLoader) {
        const $module = await import('./vidstack-Iukxkbbn.js');
